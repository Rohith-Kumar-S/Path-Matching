...
class Node:
    ...
    def __init__(self, id, y1=0, y2=0, x1=0, x2=0, val=0, is_wall=False):
        self._y1 = y1
        self._y2 = y2
        self._x1 = x1
        self._x2 = x2
    ...
    def setIsSource(self, s):
        self.is_source = s

    def setIsTarget(self, t):
        self.is_target = t
    ...
    def __str__(self):
        if self._parent != None:
            ...
            parent = -1
        if self._visited:
            return "%d (%d, %d) %.1f %s -> %d" % (self._id, self._y1, self._y2, self._x1, self._x2, self._cost, self.is_wall, parent )

        return "%d (%d, %d, %d, %d, %s) inf -> %d" % (self._id, self._y1, self._y2, self._x1, self._x2, self.is_wall, parent)
